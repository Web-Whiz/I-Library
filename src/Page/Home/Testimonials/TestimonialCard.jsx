...
const TestimonialCard = () => {
  return (
    <div className="bg-black/50 hover:shadow-md hover:shadow-slate-50 duration-200 cursor-pointer backdrop-blur-md py-10 px-5">
      <div className="h-full text-center">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="currentColor"
          class="inline-block w-8 h-8 text-white mb-8"
