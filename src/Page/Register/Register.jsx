            ...
            <div>
                <div className='relative w-full h-60'>
                    ...
                    <div className='absolute top-0 w-full h-full flex flex-col bg-[#000000a2] items-center justify-center text-white '>
                        <h1 className='font-bold text-center text-3xl'>Unlock the Library's Treasures</h1>
                        <p className=' font-bold text-center text-lg'>Open the Door to a Realm of Books and Knowledge</p>
                    </div>
                </div>
            </div>

            <div className="p-12">
                <h1 className="text-center my-8 text-3xl font-bold">Get Started Here</h1>
                <form>
                    <div className="flex items-center my-10 ">
                        <span className="bg-slate-100 p-[14px]"><FaUserAlt className="w-full text-[#0F86CD] text-2xl" /></span>
                        <input className="text-lg p-3 bg-slate-300 font-bold w-full outline-none" type="Text" name="" id="" placeholder="Name" required />
                    </div>

                    <div className="flex items-center my-10 ">
                        <span className="bg-slate-100 p-[14px]"><FaCamera className="w-full text-[#0F86CD] text-2xl" /></span>
                        <input className="text-lg p-[9px] bg-slate-300 font-bold w-full outline-none" type="file" name="" id=""  required />
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row justify-between my-2">
                        ...
                        <p>Already Have An Account?<Link href="/login" className="hover:underline text-[#0F86CD] font-bold">Login</Link></p>
                    </div>
                    <input className="text-lg p-2 bg-[#0F86CD] font-bold w-full text-white" type="submit" value="Sign Up" />
                </form>
